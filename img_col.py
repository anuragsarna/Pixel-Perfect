...
model.save('/content/drive/MyDrive/images/other_files/colorize_autoencoder.model')
...
tf.keras.models.load_model(
    '/content/drive/MyDrive/images/other_files/colorize_autoencoder.model',
    custom_objects=None,
    compile=True)

img1_color=[]

img1=img_to_array(load_img('/content/drive/MyDrive/images/test3.jpg'))
